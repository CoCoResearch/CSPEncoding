...
public class TestSECoCo {
	public static void main(String[] args) {
		...
		//Tree Constraint
		//--------------------------------------------
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_MotivadoresdeNegocio), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_SistemasEmpresariales), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_NuevovsExistente), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_Tercerizacion), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_TipodeSolucion), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_ModelodeDespliegue), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_ModelodeImplementacion), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_Mantenimiento), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_ModelodeSeleccion), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_Plataforma), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_Integracion), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_InversionTI, InversionTI_Financiacion), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_MotivadoresdeNegocio, LogOp.or(varsOrInversionTI_MotivadoresdeNegocio)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_CRM_CustomerRelationshipManagement, LogOp.nor(InversionTI_ERP_Enterpriseresourceplanning)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_CRM_CustomerRelationshipManagement, LogOp.nor(InversionTI_SCM_Sistemadegestiondeabastecimiento)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_ERP_Enterpriseresourceplanning, LogOp.nor(InversionTI_SCM_Sistemadegestiondeabastecimiento)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_SistemasEmpresariales, LogOp.or(varsXorInversionTI_SistemasEmpresariales)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_CRM_CustomerRelationshipManagement, LogOp.or(varsOrInversionTI_CRM_CustomerRelationshipManagement)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_ERP_Enterpriseresourceplanning, LogOp.or(varsOrInversionTI_ERP_Enterpriseresourceplanning)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_Adquirirsistemanuevo, LogOp.nor(InversionTI_Adaptarsistemaexistente)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_NuevovsExistente, LogOp.or(varsXorInversionTI_NuevovsExistente)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_Subcontratarpersonalizacion, LogOp.nor(InversionTI_Subcontratarpartedeldesarrolloeintegracion)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Subcontratarpersonalizacion, LogOp.nor(InversionTI_Subcontratarlaadministraciondeunprocesodenegociocompleto)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Subcontratarpersonalizacion, LogOp.nor(InversionTI_Subcontratargerenciadelproyectodeimplementacion)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Subcontratarpartedeldesarrolloeintegracion, LogOp.nor(InversionTI_Subcontratarlaadministraciondeunprocesodenegociocompleto)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Subcontratarpartedeldesarrolloeintegracion, LogOp.nor(InversionTI_Subcontratargerenciadelproyectodeimplementacion)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Subcontratarlaadministraciondeunprocesodenegociocompleto, LogOp.nor(InversionTI_Subcontratargerenciadelproyectodeimplementacion)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Tercerizacion, LogOp.or(varsXorInversionTI_Tercerizacion)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_Comercial, LogOp.nor(InversionTI_OpenSource)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_TipodeSolucion, LogOp.or(varsXorInversionTI_TipodeSolucion)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_OnPremise, LogOp.nor(InversionTI_SoftwarecomoservicioSaaS)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_OnPremise, LogOp.nor(InversionTI_InfraestructuracomoservicioIaaS)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_SoftwarecomoservicioSaaS, LogOp.nor(InversionTI_InfraestructuracomoservicioIaaS)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_ModelodeDespliegue, LogOp.or(varsXorInversionTI_ModelodeDespliegue)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_BigBang, LogOp.nor(InversionTI_Implementacionporfases)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_BigBang, LogOp.nor(InversionTI_Implementacionporprocesos)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Implementacionporfases, LogOp.nor(InversionTI_Implementacionporprocesos)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_ModelodeImplementacion, LogOp.or(varsXorInversionTI_ModelodeImplementacion)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_Contratoconelproveedor, LogOp.nor(InversionTI_Contratoconunproveedorespecializado)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Contratoconelproveedor, LogOp.nor(InversionTI_Mantenimientoporcuentapropia)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Contratoconelproveedor, LogOp.nor(InversionTI_Sincontratodemantenimiento)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Contratoconunproveedorespecializado, LogOp.nor(InversionTI_Mantenimientoporcuentapropia)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Contratoconunproveedorespecializado, LogOp.nor(InversionTI_Sincontratodemantenimiento)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Mantenimientoporcuentapropia, LogOp.nor(InversionTI_Sincontratodemantenimiento)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Mantenimiento, LogOp.or(varsXorInversionTI_Mantenimiento)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_RFP_Requestforproposal, LogOp.nor(InversionTI_Consultoriaexterna)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_RFP_Requestforproposal, LogOp.nor(InversionTI_Evaluacioninterna)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Consultoriaexterna, LogOp.nor(InversionTI_Evaluacioninterna)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_ModelodeSeleccion, LogOp.or(varsXorInversionTI_ModelodeSeleccion)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_Sistemaempresarialbasadoenlamismaplataformatecnologica, LogOp.nor(InversionTI_Sistemaempresarialbasadoenunaplataformadiferente)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Plataforma, LogOp.or(varsXorInversionTI_Plataforma)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_Middleware, LogOp.nor(InversionTI_Desarrollopropio)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Middleware, LogOp.nor(InversionTI_Proveedor)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Desarrollopropio, LogOp.nor(InversionTI_Proveedor)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Integracion, LogOp.or(varsXorInversionTI_Integracion)), solver);
		...
		SatFactory.addClauses(LogOp.implies(InversionTI_RecursosPropios, LogOp.nor(InversionTI_Credito)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_RecursosPropios, LogOp.nor(InversionTI_Leasing)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Credito, LogOp.nor(InversionTI_Leasing)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_Financiacion, LogOp.or(varsXorInversionTI_Financiacion)), solver);
		SatFactory.addClauses(LogOp.implies(InversionTI_MotivadoresdeNegocio, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Segmentarydepurarclientes, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Segmentarydepurarclientes, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Planificacionypresupuestosdemercadeo, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondedatosylistas, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondedatosylistas, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Analisisdemarketing, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Analisisdemarketing, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_GestiondeCampanias, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_GestiondeCampanias, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Facilitartareasdemercadeoypublicidad, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestionderespuestasyclientespotenciales, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Reducirciclosdeventas, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Reducirciclosdeventas, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Aumentartasasdecierredeventas, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Aumentartasasdecierredeventas, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Mejorarretenciondeclientes, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Mejorarretenciondeclientes, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Implementarnuevoprocesodeventas, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Implementarnuevoprocesodeventas, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestionarinformaciondeclientes, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestionarinformaciondeclientes, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondecasosdeclientes, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondecasosdeclientes, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Historialdeserviciosdeclientes, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Historialdeserviciosdeclientes, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Aumentarbasedeclientes, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Aumentarbasedeclientes, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Implementarnuevoprocesodeatencionalcliente, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Mejorarconocimientodelcliente, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Mejorarconocimientodelcliente, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Medirsatisfacciondelconsumidor, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Medirsatisfacciondelconsumidor, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Controlsobrerecursoshumanos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Controlsobrerecursoshumanos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Nuevosprocesosderecursoshumanos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Nuevosprocesosderecursoshumanos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Reclutamiento, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Reclutamiento, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Biodata_hojasdevida, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Biodata_hojasdevida, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Analisisdecargos_estructuraorganizacional, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Nominayadministraciondesalarios, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Nominayadministraciondesalarios, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Educacionycapacitacion, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Educacionycapacitacion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Saludocupacional, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Saludocupacional, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Modelamientodeprocesosyorganigramas, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Nuevosprocesosfinancieros, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Nuevosprocesosfinancieros, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Implementarcontrolessobreprocesosfinancieros, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestioncontable, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestioncontable, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodecuentasporpagar_Proveedores, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Sistemasdecosteo, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Sistemasdecosteo, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Administraciondeactivosfijos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Administraciondeactivosfijos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Manejodeconciliacionesbancarias, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodeconciliacionesbancarias, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Controldeinversiones, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Controldeinversiones, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Manejodeobligacionesfinancieras, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodeobligacionesfinancieras, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Tesoreria, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Tesoreria, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Contabilidadanalitica, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Contabilidadanalitica, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Controlyadministraciondelpresupuesto, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Manejodeactivosdecapital, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodeactivosdecapital, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Manejodeinventarios, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodeinventarios, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Manejodealmacen, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodealmacen, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondecompras, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondecompras, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondeactivosfijos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondeactivosfijos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Comercioexterior, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Comercioexterior, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Seguros, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Seguros, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Manejodeordenesdeproduccion, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodeordenesdeproduccion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Manejodeordenesdecompra, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Manejodeordenesdecompra, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Planificaciondenecesidadesdecapacidad, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Planificaciondesuministros, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Planificaciondesuministros, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Disminuirtiemposdeentrega, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Disminuirtiemposdeentrega, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Integracionconproveedores, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Integracionconproveedores, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondeproveedores, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondeproveedores, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Administraciondemateriasprimas, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Administraciondemateriasprimas, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondebodega, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondebodega, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Realizarcontroldecostos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Realizarcontroldecostos, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Administraciondepedidosydespachos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondecontactos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondecontactos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Ajustarprocesosdeflujodetrabajo, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Ajustarprocesosdeflujodetrabajo, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Mejorarcapacidadderespuesta, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Mejorarcapacidadderespuesta, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestionarpresupuestos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestionarpresupuestos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Crearyconsolidarinformes, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Crearyconsolidarinformes, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Buscartendenciasyrelaciones, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Buscartendenciasyrelaciones, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Compartirconocimiento, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Compartirconocimiento, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Organizarrecursosdeservicio, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Organizarrecursosdeservicio, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Facturacionydevolucion, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Facturacionydevolucion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Cartera, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Cartera, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Administraciondepreciosydescuentos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Administraciondepromociones, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Administraciondepromociones, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Administraciondecuotaseincentivos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Administraciondevisitacomercial, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Administraciondevisitacomercial, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Importacionesyexportaciones, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Importacionesyexportaciones, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestionarcontratosdeservicio, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestionarcontratosdeservicio, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Presupuestarcostosytiempos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Presupuestarcostosytiempos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Automatizarlafacturacion, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Automatizarlafacturacion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Predecirdisponibilidades, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Predecirdisponibilidades, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Seguimientodecostosyconsumos, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Seguimientodecostosyconsumos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Planificarcapacidades, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Planificarcapacidades, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Planearygestionarcapacidaddebodegajeyalmacenamiento, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondetransportedemercancia, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondetransportedemercancia, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Logisticadetransporteinternacional, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestionderelacionconproveedores, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestionderelacionconproveedores, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Gestiondelademanda, InversionTI_MotivadoresdeNegocio), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_MotivadoresdeNegocio, "=", 0), IntConstraintFactory.arithm(InversionTI_Gestiondelademanda, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_SistemasEmpresariales, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_SistemasEmpresariales, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_SistemasEmpresariales, "=", 0), IntConstraintFactory.arithm(InversionTI_CRM_CustomerRelationshipManagement, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_CRM_CustomerRelationshipManagement, "=", 0), IntConstraintFactory.arithm(InversionTI_CRM_Modulomarketing, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_CRM_ModuloVentas, InversionTI_CRM_CustomerRelationshipManagement), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_CRM_CustomerRelationshipManagement, "=", 0), IntConstraintFactory.arithm(InversionTI_CRM_ModuloVentas, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_CRM_CustomerRelationshipManagement, "=", 0), IntConstraintFactory.arithm(InversionTI_CRM_Modulodeclientes, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ERP_Enterpriseresourceplanning, InversionTI_SistemasEmpresariales), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_SistemasEmpresariales, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Modulorecursoshumanos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ERP_Modulofinanciero, InversionTI_ERP_Enterpriseresourceplanning), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Modulofinanciero, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Moduloadministrativo, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ERP_Modulodeproduccion, InversionTI_ERP_Enterpriseresourceplanning), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Modulodeproduccion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ERP_Modulodeclientes, InversionTI_ERP_Enterpriseresourceplanning), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Modulodeclientes, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Modulodegestiondeabastecimiento, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Modulodeinteligenciadenegocio, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ERP_Marketingyventas, InversionTI_ERP_Enterpriseresourceplanning), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Marketingyventas, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ERP_Enterpriseresourceplanning, "=", 0), IntConstraintFactory.arithm(InversionTI_ERP_Modulodegestiondeproyectos, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_SistemasEmpresariales, "=", 0), IntConstraintFactory.arithm(InversionTI_SCM_Sistemadegestiondeabastecimiento, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_NuevovsExistente, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_NuevovsExistente, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Adquirirsistemanuevo, InversionTI_NuevovsExistente), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_NuevovsExistente, "=", 0), IntConstraintFactory.arithm(InversionTI_Adquirirsistemanuevo, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Adaptarsistemaexistente, InversionTI_NuevovsExistente), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_NuevovsExistente, "=", 0), IntConstraintFactory.arithm(InversionTI_Adaptarsistemaexistente, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Tercerizacion, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_Tercerizacion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Subcontratarpersonalizacion, InversionTI_Tercerizacion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Tercerizacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Subcontratarpersonalizacion, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Tercerizacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Subcontratarpartedeldesarrolloeintegracion, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Tercerizacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Subcontratarlaadministraciondeunprocesodenegociocompleto, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Tercerizacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Subcontratargerenciadelproyectodeimplementacion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_TipodeSolucion, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_TipodeSolucion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Comercial, InversionTI_TipodeSolucion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_TipodeSolucion, "=", 0), IntConstraintFactory.arithm(InversionTI_Comercial, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_OpenSource, InversionTI_TipodeSolucion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_TipodeSolucion, "=", 0), IntConstraintFactory.arithm(InversionTI_OpenSource, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ModelodeDespliegue, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_ModelodeDespliegue, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_OnPremise, InversionTI_ModelodeDespliegue), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeDespliegue, "=", 0), IntConstraintFactory.arithm(InversionTI_OnPremise, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_SoftwarecomoservicioSaaS, InversionTI_ModelodeDespliegue), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeDespliegue, "=", 0), IntConstraintFactory.arithm(InversionTI_SoftwarecomoservicioSaaS, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_InfraestructuracomoservicioIaaS, InversionTI_ModelodeDespliegue), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeDespliegue, "=", 0), IntConstraintFactory.arithm(InversionTI_InfraestructuracomoservicioIaaS, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ModelodeImplementacion, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_ModelodeImplementacion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_BigBang, InversionTI_ModelodeImplementacion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeImplementacion, "=", 0), IntConstraintFactory.arithm(InversionTI_BigBang, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Implementacionporfases, InversionTI_ModelodeImplementacion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeImplementacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Implementacionporfases, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Implementacionporprocesos, InversionTI_ModelodeImplementacion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeImplementacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Implementacionporprocesos, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Mantenimiento, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_Mantenimiento, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Contratoconelproveedor, InversionTI_Mantenimiento), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Mantenimiento, "=", 0), IntConstraintFactory.arithm(InversionTI_Contratoconelproveedor, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Contratoconunproveedorespecializado, InversionTI_Mantenimiento), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Mantenimiento, "=", 0), IntConstraintFactory.arithm(InversionTI_Contratoconunproveedorespecializado, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Mantenimientoporcuentapropia, InversionTI_Mantenimiento), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Mantenimiento, "=", 0), IntConstraintFactory.arithm(InversionTI_Mantenimientoporcuentapropia, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Sincontratodemantenimiento, InversionTI_Mantenimiento), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Mantenimiento, "=", 0), IntConstraintFactory.arithm(InversionTI_Sincontratodemantenimiento, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_ModelodeSeleccion, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_ModelodeSeleccion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_RFP_Requestforproposal, InversionTI_ModelodeSeleccion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeSeleccion, "=", 0), IntConstraintFactory.arithm(InversionTI_RFP_Requestforproposal, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Consultoriaexterna, InversionTI_ModelodeSeleccion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeSeleccion, "=", 0), IntConstraintFactory.arithm(InversionTI_Consultoriaexterna, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Evaluacioninterna, InversionTI_ModelodeSeleccion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_ModelodeSeleccion, "=", 0), IntConstraintFactory.arithm(InversionTI_Evaluacioninterna, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Plataforma, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_Plataforma, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Plataforma, "=", 0), IntConstraintFactory.arithm(InversionTI_Sistemaempresarialbasadoenlamismaplataformatecnologica, "=", 0));
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Plataforma, "=", 0), IntConstraintFactory.arithm(InversionTI_Sistemaempresarialbasadoenunaplataformadiferente, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Integracion, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_Integracion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Middleware, InversionTI_Integracion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Integracion, "=", 0), IntConstraintFactory.arithm(InversionTI_Middleware, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Desarrollopropio, InversionTI_Integracion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Integracion, "=", 0), IntConstraintFactory.arithm(InversionTI_Desarrollopropio, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Proveedor, InversionTI_Integracion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Integracion, "=", 0), IntConstraintFactory.arithm(InversionTI_Proveedor, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Financiacion, InversionTI_InversionTI), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_InversionTI, "=", 0), IntConstraintFactory.arithm(InversionTI_Financiacion, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_RecursosPropios, InversionTI_Financiacion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Financiacion, "=", 0), IntConstraintFactory.arithm(InversionTI_RecursosPropios, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Credito, InversionTI_Financiacion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Financiacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Credito, "=", 0));
		SatFactory.addClauses(LogOp.implies(InversionTI_Leasing, InversionTI_Financiacion), solver);
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(InversionTI_Financiacion, "=", 0), IntConstraintFactory.arithm(InversionTI_Leasing, "=", 0));
