...
public class TestMobilePhone1CoCo {
	public static void main(String[] args) {
		...
		//Tree Constraint
		//--------------------------------------------
		SatFactory.addClauses(LogOp.implies(MobilePhone_MobilePhone, MobilePhone_UtilityFunction), solver);
		SatFactory.addClauses(LogOp.implies(MobilePhone_MobilePhone, MobilePhone_Settings), solver);
		SatFactory.addClauses(LogOp.implies(MobilePhone_MobilePhone, MobilePhone_Connectivity), solver);
		SatFactory.addClauses(LogOp.implies(MobilePhone_UtilityFunction, MobilePhone_Calls), solver);
		SatFactory.addClauses(LogOp.implies(MobilePhone_UtilityFunction, MobilePhone_Messaging), solver);
		SatFactory.addClauses(LogOp.implies(MobilePhone_UtilityFunction, MobilePhone_Alarm), solver);
		...
		SatFactory.addClauses(LogOp.implies(MobilePhone_Settings, MobilePhone_OS), solver);
